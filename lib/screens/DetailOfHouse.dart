                ...
                children: <Widget>[
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              child: Text("COSY ROOM 2, 3 Bed Rooms, Luxury Apartement",
                                style: TextStyle(fontSize: 22, color: Colors.grey[800], fontWeight: FontWeight.bold),
                              ),
                            ),

                            SizedBox(height: 8,),
                            Text("Boulevard Mohammed V",
                      ...
                      children: <Widget>[
                        Row(
                          children: <Widget>[
                            ...
                            SizedBox(width: 4,),
                            Text("3 etudiant", style: TextStyle(color: Colors.grey[600], fontWeight: FontWeight.w500),)
                          ],
                        ),
                        Row(
                          children: <Widget>[
                            ...
                            SizedBox(width: 4,),
                            Text("3 Beds", style: TextStyle(color: Colors.grey[600], fontWeight: FontWeight.w500),)
                          ],
                        ),
                        Row(
                          children: <Widget>[
                            ...
                            SizedBox(width: 4,),
                            Text("3 Bathrooms", style: TextStyle(color: Colors.grey[600], fontWeight: FontWeight.w500),)
                          ],
                        ),
                      ],
                    ),
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              Text("hamid ", style: TextStyle(color: Colors.grey[800], fontSize : 18, fontWeight: FontWeight.w600),),
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        Text("Future", style: TextStyle(color: Colors.grey[800], fontSize: 18, fontWeight: FontWeight.w600), ),
                        SizedBox(height: 16,),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: <Widget>[
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                SizedBox(width: 4,),
                                Text("jardin", style: TextStyle(color: Colors.grey[600], fontWeight: FontWeight.w500),)
                              ],
                            ),
                          ],
                        ),
